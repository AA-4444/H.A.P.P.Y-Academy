  ...
  return (
    <section id="about" className="bg-white">
      <QuoteFullscreen
        bg={quoteBg}
        avatar={quoteAvatar}
        name="Іцхак Пінтосевич"
        quote="Архітектор Щастя"
        subline={`Психолог працює з минулим.
Коуч — з цілями.
Архітектор Щастя проєктує внутрішній світ, у якому добре жити.

30+ років практики
тисячі учнів
автор системного підходу до щастя
людина, яка спочатку побудувала свій дім, а потім почала допомагати іншим`}
        reels={reels}
      />
    ...
    <section className="relative h-screen w-full overflow-hidden bg-black">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-6 sm:px-10 lg:px-16">
        ...
        <div className="sm:hidden w-full text-center">
          ...
          >
            Сьогодні він автор бестселерів і наставник, який змінив життя мільйонів.
          </motion.h3>
