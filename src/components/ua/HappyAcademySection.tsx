          ...
          <div className="relative px-6 sm:px-10 lg:px-14 py-12 sm:py-14 lg:py-16">
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-start">
              ...
              <div className="max-w-xl min-w-0">
                ...
                >
                  Чому люди втрачають енергію
                  <br className="hidden sm:block" /> і радість життя
                </motion.h2>
                ...
                >
                  Постійний стрес, перевантаження роботою, втрата фокусу та
                  відсутність часу на себе. У результаті людина втрачає енергію
                  і перестає відчувати радість життя.
                </motion.p>
              </div>

              {/* RIGHT */}
              <div className="max-w-2xl min-w-0 space-y-4">
                <MotionChip>постійний стрес</MotionChip>
                <MotionChip>перевантаження роботою</MotionChip>
                <MotionChip>втрата фокусу</MotionChip>
                <MotionChip>відсутність часу на себе</MotionChip>
                <MotionChip>втрата енергії та радості життя</MotionChip>

                <div className="pt-3 grid gap-2 sm:gap-3">
                  <MotionPoint>немає внутрішнього ресурсу</MotionPoint>
                  <MotionPoint>складно відновитися та сповільнитися</MotionPoint>
                  <MotionPoint>життя перетворюється на постійну гонитву</MotionPoint>
                </div>
        ...
        <div className="max-w-4xl text-center">
          ...
          >
            ...
            <p className="mt-6 text-white/85 text-base sm:text-lg md:text-xl leading-relaxed max-w-3xl mx-auto">
              Постійний стрес — перевантаження роботою — втрата фокусу —
              відсутність часу на себе. У результаті людина втрачає енергію
              і перестає відчувати радість життя.
            </p>
          </motion.div>
