...
const itemsBase = [
  { label: "10 елементів щастя - структурна система" },
  { label: "Підтримка кураторів і супровід" },
  { label: "Відеоуроки та практичні заняття" },
  { label: "Сесії запитання-відповідь з Іцхаком Пінтосевичем" },
];
          ...
          <div className="max-w-fit w-full flex flex-col items-start">
            ...
            >
              ...
              <div className="flex flex-col w-full">
                ...
                >
                  Ти вибудовуєш внутрішню опору та баланс - через систему, а не
                  через натхнення.
                </motion.p>
