    ...
    () => [
      {
        ...
        name: "Ігор Рибаков",
        subtitle:
          "Мільярдер, співзасновник корпорації ТЕХНОНІКОЛЬ, інвестор, учасник списку Forbes",
        text: `«Іцхак, дякую! Ти перша людина, яка так потужно зробила захід у “духовно-матеріальні плани”. Усі думають, що в духовному і матеріальному плані в мене всі амбіції задоволені. Але, звісно ж, не всі))) Дякую тобі, мій дорогий друже!».`,
      },
      {
        id: "chernyak",
        avatar: avaOlga,
        name: "Євген Черняк",
        subtitle:
          "Підприємець, засновник Global Spirits. Автор бізнес-подкасту Big Money, мультимільйонер",
        text: `«Іцхак — тренер №1, за нашими вимірами, після якого зростає ефективність торгової команди».`,
      },
      {
        id: "hartmann",
        avatar: avaGalina,
        name: "Оскар Хартманн",
        subtitle:
          "Серійний підприємець і венчурний інвестор. Співзасновник KupiVIP, інвестор 100+ стартапів, мультимільйонер",
        text: `«Іцхак — один із провідних людей, який говорить про всі питання, про які не говорять у школі».

Передмова з книги «Роби Просто. Просто роби»:
«Якби не Іцхак, цієї книги б не було».`,
      },
    ],
    []
  );
              ...
              {testimonials.map((p, i) => {
                ...
                return (
                  <button
                    ...
                    aria-label={`Показати відгук: ${p.name}`}
                  >
                    <div
                      className={[
